...
def model_opts(parser):
    ...
    group.add_argument(
        '-rnn_size', type=int, default=500, help='Size of rnn hidden states')
    group.add_argument(
        '-dim_vid',
        type=int,
        default=2048,
        help='dim of video features input to encoder')
    group.add_argument(
        '-cnn_kernel_width',
        type=int,
        default=3,
...
def preprocess_opts(parser):
    ...
    group.add_argument(
        '-src_vocab', help="Path to an existing source vocabulary")
    group.add_argument(
        '-tgt_vocab', help="Path to an existing target vocabulary")
    group.add_argument(
...
def train_opts(parser):
    ...
    group.add_argument(
        ...
        help="""Maximum batches of words in a sequence to run
                        ...
                        uses more memory.""")
    group.add_argument(
        '-epochs', type=int, default=13, help='Number of training epochs')
    group.add_argument(
        '-optim',
        default='sgd',
...
def translate_opts(parser):
    ...
    group.add_argument(
        '-beta', type=float, default=-0., help="""Coverage penalty parameter""")
    group.add_argument(
        '-replace_unk',
        action="store_true",
...
class MarkdownHelpFormatter(argparse.HelpFormatter):
    ...
    def _format_action(self, action):
        if action.dest == "help" or action.dest == "md":
            return ""
        lines = []
        lines.append('* **-%s %s** ' % (action.dest, "[%s]" % action.default
